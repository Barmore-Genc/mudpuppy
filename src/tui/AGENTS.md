...
- `app.rs`: viewer state — `App` and its verbs (scroll, cursor move, visual selection, select, focus, release turn, reload), plus `Focus`, `Row`, and the lazily-built per-file `FileView`.
